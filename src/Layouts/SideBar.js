...
function SideBar() {
  ...
  return (
    <div>
      <div className="flex bg-[#f1eeee] py-4 flex-nowrap h-[100%] mt-20 fixed flex-col w-60 z-10">
        <Link to="/home">
          <div className=" flex rounded-lg  px-5 text-2xl bg-[#008DB9] w-50 ml-5 mr-5 mt-5 hover:bg-[#43a1d6] hover:shadow-sm hover:shadow-sky-700">
            <span>
