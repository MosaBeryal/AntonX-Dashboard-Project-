...
export default function Slider1() {
  ...
  <div className="carousel-item">
    <img src={img1} className="rounded-box" width="600px" alt='img1' />
  </div> 
  <div className="carousel-item">
    <img src={img2} className="rounded-box" width="600px" alt='img2' />
  </div> 
  <div className="carousel-item">
    <img src={img3} className="rounded-box" width="600px" alt='img3'
    />
  </div> 
  <div className="carousel-item">
    <img src={img4} className="rounded-box" width="600px" alt='img4' />
  </div> 
